...
namespace Povox {
	...
	void ImGuiLayer::SetDarkThemeColors()
	{
		...
		colors[ImGuiCol_HeaderActive] = ImVec4{ 0.1f, 0.105f, 0.11f, 1.0f };
		colors[ImGuiCol_HeaderHovered] = ImVec4{ 0.1f, 0.105f, 0.11f, 1.0f };

		// Buttons
		colors[ImGuiCol_Button] = ImVec4{ 0.1f, 0.105f, 0.11f, 1.0f };
		colors[ImGuiCol_ButtonActive] = ImVec4{ 0.1f, 0.105f, 0.11f, 1.0f };
		colors[ImGuiCol_ButtonHovered] = ImVec4{ 0.1f, 0.105f, 0.11f, 1.0f };

		// Frame BG
		colors[ImGuiCol_FrameBg] = ImVec4{ 0.1f, 0.105f, 0.11f, 1.0f };
		colors[ImGuiCol_FrameBgActive] = ImVec4{ 0.1f, 0.105f, 0.11f, 1.0f };
		colors[ImGuiCol_FrameBgHovered] = ImVec4{ 0.1f, 0.105f, 0.11f, 1.0f };
