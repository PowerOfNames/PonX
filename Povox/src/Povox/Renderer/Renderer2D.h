...
namespace Povox {
	...
	// Primitives
		...
		static void DrawQuad(const glm::vec2& position, const glm::vec2 size, const std::string& texture);
		static void DrawQuad(const glm::vec3& position, const glm::vec2 size, const std::string& texture);
