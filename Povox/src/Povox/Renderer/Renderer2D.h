...
namespace Povox {
	...
	// Primitives
		...
		static void DrawQuad(const glm::mat4& transform, const glm::vec4& color, UUID entityID = UUID());
		...
		static void DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, float tilingFactor = 1.0f, const glm::vec4& tintingColor = glm::vec4(1.0f), UUID entityID = UUID());
		...
		static void DrawQuad(const glm::mat4& transform, const Ref<SubTexture2D>& texture, float tilingFactor = 1.0f, const glm::vec4& tintingColor = glm::vec4(1.0f), UUID entityID = UUID());
